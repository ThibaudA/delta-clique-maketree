...
cliquesnbnodesmax=sorted(cliquesliste,key=operator.itemgetter(3))[-3000:]
cliquesnbnodesmaxtmpsmax=sorted(cliquesnbnodesmax,key=operator.itemgetter(4))[-50:]

for c in cliquesnbnodesmaxtmpsmax:
	print c[3],c[4]
